          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className={`text-xs font-medium ${
                isValidDistribution() ? 'text-green-900' : 'text-amber-900'
              }`}>
                Total Property: {bedroomsFromDetails} bed, {bathroomsFromDetails} bath
              </span>
            </div>
            <span className={`text-xs ${
              isValidDistribution() ? 'text-green-700' : 'text-amber-700'
            }`}>
        ...
        <div className="space-y-4">
            ...
            {units.map((unit, index) => (
              ...
              >
                ...
                <div className={`bg-gradient-to-br ${
                  ...
                  unit.unit_type === 'adu' ? 'border-blue-200' : 'border-gray-200'
                }`}>
                  {/* Unit Header */}
                    ...
                    {(() => {
                      ...
                      return (
                        <div className={`bg-white rounded-lg p-3 border ${
                          ...
                          isDuplex ? 'border-blue-200 hover:border-blue-300' :
                          ...
                          <div className="flex items-center justify-between mb-1.5">
                            <span className="text-xs font-medium text-gray-600 group-hover:text-gray-900 transition-colors">
                              ...
                              Bedrooms
                              {isLocked && <Lock className="h-3 w-3 inline ml-1 text-gray-400" />}
                            </span>
                    ...
                    <div className="bg-white rounded-lg p-3 border border-gray-200 hover:border-blue-300 transition-colors group">
                      ...
                      {editing?.unitIndex === index && editing?.field === 'size' ? (
                        ...
                        <button
                          ...
                          className="w-full text-left px-2.5 py-1.5 text-sm font-medium border border-gray-200 rounded-md hover:bg-gray-50 transition-all"
                        >
                          {unit.size || '+ Add'}
                        </button>
                      )}
          ...
          {config.canAddADU && !hasADU && (
            <motion.button
              ...
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="w-full group relative overflow-hidden rounded-xl border-2 border-dashed border-gray-300 bg-gradient-to-br from-gray-50 to-gray-100/50 p-4 hover:border-blue-400 hover:from-blue-50 hover:to-indigo-50/50 transition-all duration-300"
            >
              <div className="flex items-center justify-center gap-2">
                <Key className="h-5 w-5 text-gray-400 group-hover:text-blue-600 transition-colors" />
      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="bg-blue-50 rounded-xl p-3.5 border border-blue-200">
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-xs font-semibold text-blue-900 mb-1">Quick Setup Only</p>
