      ...
      <div className="space-y-4">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold transition-colors duration-300
              ${formData.status === PropertyStatus.ACTIVE 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2 space-y-4">
            ...
            <motion.div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 transition-colors duration-300">
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-3 transition-colors duration-300">Mixed Use Details</h4>
              <div className="grid grid-cols-4 gap-2">
                {residentialSquareFeet && (
                  <div className="text-center p-2 bg-green-50 dark:bg-green-900/20 rounded-lg transition-colors duration-300">
                    <Home className="h-4 w-4 mx-auto text-green-600 dark:text-green-400 mb-1" />
                    <div className="text-sm font-semibold text-gray-900 dark:text-gray-100 transition-colors duration-300">{Number(residentialSquareFeet).toLocaleString()}</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400 transition-colors duration-300">Res SF</div>
                  </div>
                )}
                {commercialSquareFeet && (
                  <div className="text-center p-2 bg-purple-50 dark:bg-purple-900/20 rounded-lg transition-colors duration-300">
                    <Store className="h-4 w-4 mx-auto text-purple-600 dark:text-purple-400 mb-1" />
                    <div className="text-sm font-semibold text-gray-900 dark:text-gray-100 transition-colors duration-300">{Number(commercialSquareFeet).toLocaleString()}</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400 transition-colors duration-300">Com SF</div>
                  </div>
                )}
                {(resUnitsCount || 0) > 0 && (
                  <div className="text-center p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg transition-colors duration-300">
                    ...
                    <div className="text-sm font-semibold text-gray-900 dark:text-gray-100 transition-colors duration-300">{resUnitsCount}</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400 transition-colors duration-300">Res Units</div>
                  </div>
                )}
                {(comUnitsCount || 0) > 0 && (
                  <div className="text-center p-2 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg transition-colors duration-300">
                    <Building className="h-4 w-4 mx-auto text-indigo-600 dark:text-indigo-400 mb-1" />
                    <div className="text-sm font-semibold text-gray-900 dark:text-gray-100 transition-colors duration-300">{comUnitsCount}</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400 transition-colors duration-300">Com Spaces</div>
                  </div>
                )}
              </div>
            </motion.div>
