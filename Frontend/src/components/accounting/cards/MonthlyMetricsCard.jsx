  ...
  return (
    <div className="kpi-card group h-full flex flex-col">
      <div className="flex items-center mb-4">
        <h2 className="text-base font-medium text-gray-800 dark:text-gray-200 whitespace-nowrap">This Month</h2>
        <div className="kpi-sparkline bg-gradient-to-r from-blue-200 to-blue-300 dark:from-blue-800"></div>
      </div>
