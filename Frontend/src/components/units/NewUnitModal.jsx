...
const NewUnitModal = ({
  ...
  useEffect(() => {
    if (isOpen) {
      // Reset error and form when modal opens
      setError("");
      setFormData({
        name: "",
        floor: "",
    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-blue-700">
                <p className="font-medium">New units are created as vacant</p>
                <p className="mt-1">To assign a tenant, use the "Assign" button after creating the unit.</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} id="new-unit-form" className="space-y-6">
            {/* Required Fields */}
