...
const NewUnitModal = ({ isOpen, onClose, onSubmit, propertyId, isLoading, initialData = null, mode = 'create' }) => {
    ...
    if (isOpen) {
      ...
      if (initialData && mode === 'edit') {
        setFormData({
          ...
          monthly_rent: initialData.monthly_rent !== null ? initialData.monthly_rent : '',
    ...
    >
      ...
      >
        ...
        <div className="px-6 py-4 bg-white border-b border-gray-200 flex justify-between items-center">
          <h2 className="text-xl font-semibold text-gray-900">{mode === 'edit' ? 'Edit Unit' : 'Add New Unit'}</h2>
          <button
            onClick={handleClose}
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Floor */}
            <div>
              <label htmlFor="floor" className="block text-sm font-medium text-gray-700 mb-1 after:content-['*'] after:ml-0.5 after:text-red-500">
                Floor
              </label>
              <input
                id="floor"
            ...
            <div>
              ...
              <div className="mt-2">
                <label className="inline-flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-gray-700">Unit is currently rented</span>
                </label>
              </div>
            </div>
          </form>
