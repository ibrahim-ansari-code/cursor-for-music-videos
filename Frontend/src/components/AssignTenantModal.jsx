...
const AssignTenantModal = ({ isOpen, onClose, onSubmit, propertyId, unitId, unitName, isLoading }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(`Assigning tenant (ID: ${selectedTenant}) to unit (ID: ${unitId}) with rent: ${monthlyRent}`);
      ...
      >
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Tenant Dropdown */}
            <div>
              <label htmlFor="tenant" className="block text-sm font-medium text-gray-700 mb-1 after:content-['*'] after:ml-0.5 after:text-red-500">
                Select Tenant
              </label>
              ...
              {isLoadingTenants ? (
                <div className="flex items-center justify-center py-4">
                  ...
                  <span className="ml-2 text-sm text-gray-600">Loading tenants...</span>
                </div>
                ...
                <div className="p-4 text-center text-gray-500 border border-gray-200 rounded-lg">
                  {searchTerm ? 'No tenants match your search' : 'No tenants available for this property'}
                </div>
              )}
            </div>
            ...
            {/* Monthly Rent Input */}
            <div>
              <label htmlFor="monthlyRent" className="block text-sm font-medium text-gray-700 mb-1 after:content-['*'] after:ml-0.5 after:text-red-500">
                Monthly Rent
              </label>
