...
const ResetPassword: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const parseUrlTokens = (): { accessToken: string | null; refreshToken: string | null; type: string | null } => {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData(prev => ({ ...prev, confirmPassword: e.target.value }))}
              />
            </div>
