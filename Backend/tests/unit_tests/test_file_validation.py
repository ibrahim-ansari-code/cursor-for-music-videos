...
class TestDetectFileTypeByMagic:
    """Tests for detect_file_type_by_magic function."""
...
class TestValidateReceiptFile:
    """Tests for validate_receipt_file function."""
    ...
    def test_mime_type_mismatch_warning(self, caplog):
    ...
    def test_disallowed_mime_type(self, monkeypatch):
...
class TestValidateFileFromUpload:
    """Tests for validate_file_from_upload function."""
    ...
    @pytest.mark.asyncio
    async def test_sync_file_object(self):
    ...
    @pytest.mark.asyncio
    async def test_sync_read_returning_awaitable(self):
    ...
    @pytest.mark.asyncio
    async def test_file_without_seek(self):
    ...
    @pytest.mark.asyncio
    async def test_sync_seek_method(self):
    ...
    @pytest.mark.asyncio
    async def test_seek_exception_ignored(self):
    ...
    @pytest.mark.asyncio
    async def test_no_read_method(self):
    ...
    @pytest.mark.asyncio
    async def test_non_bytes_content(self):
    ...
    @pytest.mark.asyncio
    async def test_declared_mime_type_passed_through(self):
    ...
    @pytest.mark.asyncio
    async def test_mixed_async_sync_methods(self):
    ...
    @pytest.mark.asyncio
    async def test_async_seek_method(self):
...
class TestRealWorldScenarios:
    """Tests with real-world file scenarios."""
    
    @pytest.mark.asyncio
    async def test_fastapi_upload_file(self):
    ...
    @pytest.mark.asyncio
    async def test_large_file_within_limit(self):
