...
if os.path.exists(dotenv_path):
    ...
    if os.path.exists(".env"): 
        ...
        print(f"WARNING: Root .env file not found at {dotenv_path} and no .env in current directory. Environment variables might not be fully loaded.")
...
def check_env():
    ...
    if missing_required:
        ...
        print("   `python Backend/tests/test_auth_helper.py` (and enter password for zubinsingh05@gmail.com if prompted)")
