...
def upgrade() -> None:
    ...
    op.create_table('users',
                    ...
                    sa.Column(
                        'phone', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
                    sa.Column(
                        'address', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
                    sa.Column(
                        'city', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
                    sa.Column(
                        'province', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
                    sa.Column('postal_code', sqlmodel.sql.sqltypes.AutoString(),
                              nullable=True),
    ...
    op.create_table('messages',
                    ...
                    sa.Column('message_type', sa.Enum('DIRECT', 'ANNOUNCEMENT',
                                                      'SYSTEM', name='messagetype'), nullable=False),
    ...
    op.create_table('properties',
                    ...
                    sa.Column('province', sqlmodel.sql.sqltypes.AutoString(),
                              nullable=False),
                    sa.Column('postal_code', sqlmodel.sql.sqltypes.AutoString(),
                              nullable=False),
    ...
    op.create_table('vendors',
                    ...
                    sa.Column('business_type',
                              sqlmodel.sql.sqltypes.AutoString(), nullable=False),
                    sa.Column(
                        'tax_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
                    sa.Column(
                        'website', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
                    sa.Column('status', sa.Enum('PENDING', 'APPROVED', 'DENIED',
                                                'INACTIVE', name='vendorstatus'), nullable=False),
                    sa.Column('insurance_provider',
                              sqlmodel.sql.sqltypes.AutoString(), nullable=True),
                    sa.Column('insurance_policy_number',
                              sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_table('expenses',
                    ...
                    sa.Column('receipt_url', sqlmodel.sql.sqltypes.AutoString(),
                              nullable=True),
    ...
    op.create_table('invoices',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column(
                        'invoice_number', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
                    sa.Column('amount', sa.Float(), nullable=False),
                    sa.Column('description', sqlmodel.sql.sqltypes.AutoString(),
                              nullable=False),
                    sa.Column('issue_date', sa.Date(), nullable=False),
                    sa.Column('due_date', sa.Date(), nullable=False),
                    sa.Column('status', sa.Enum('PENDING', 'PAID', 'LATE', 'PARTIAL',
                                                'OVERDUE', 'REFUNDED', name='paymentstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_property_units_name'),
                    'property_units', ['name'], unique=False)
    ...
    op.create_table('tenants',
                    ...
                    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'PENDING',
                                                'EVICTION', name='tenantstatus'), nullable=False),
                    sa.Column('created_at', sa.DateTime(), nullable=False),
                    sa.Column('updated_at', sa.DateTime(), nullable=False),
                    sa.Column('current_property_id',
    ...
    op.create_index(op.f('ix_tenants_user_id'),
                    'tenants', ['user_id'], unique=False)
    ...
    op.create_table('leases',
                    ...
                    sa.Column('status', sa.Enum('DRAFT', 'PENDING', 'ACTIVE', 'EXPIRED',
                                                'TERMINATED', 'RENEWED', name='leasestatus'), nullable=False),
                    ...
                    sa.Column('late_fee_after_days',
                              sa.Integer(), nullable=True),
                    sa.Column('special_terms',
                              sqlmodel.sql.sqltypes.AutoString(), nullable=True),
                    sa.Column('property_id', sa.Integer(), nullable=False),
    ...
    op.create_table('payments',
                    ...
                    sa.Column('status', sa.Enum('PENDING', 'PAID', 'LATE', 'PARTIAL',
                                                'OVERDUE', 'REFUNDED', name='paymentstatus'), nullable=False),
                    sa.Column('transaction_reference',
                              sqlmodel.sql.sqltypes.AutoString(), nullable=True),
                    sa.Column(
