...
def upgrade() -> None:
    ...
    propertystatus = sa.Enum('ACTIVE', 'INACTIVE',
                             'DRAFT', 'ARCHIVED', name='propertystatus')
    ...
    op.alter_column('properties', 'updated_at',
                    existing_type=postgresql.TIMESTAMP(),
                    nullable=True)
    op.drop_constraint('properties_owner_id_fkey',
...
def downgrade() -> None:
    ...
    op.create_foreign_key('properties_owner_id_fkey',
    ...
    op.alter_column('properties', 'status',
                    existing_type=sa.Enum(
                        'ACTIVE', 'INACTIVE', 'DRAFT', 'ARCHIVED', name='propertystatus', create_constraint=True),
                    type_=sa.VARCHAR(),
                    nullable=True)
    op.alter_column('properties', 'property_type',
                    existing_type=sa.VARCHAR(),
